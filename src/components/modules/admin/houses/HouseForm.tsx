...
export function HouseForm({
    ...
    const toggleHouseGroupSelection = (groupId: string) => {
        ...
        const nextIds = currentIds.includes(groupId)
            ...
            : [...currentIds, groupId];
        setValue("house_group_ids", nextIds, { shouldValidate: true, shouldDirty: true });
    };
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
                ...
                <div className={cn(
                    ...
                    errors.house_group_ids ? "border-destructive bg-destructive/5" : "border-input"
                )}>
                ...
                {errors.house_group_ids && (
                    <p className="text-xs text-destructive mt-1">{errors.house_group_ids.message}</p>
                )}
            </div>
