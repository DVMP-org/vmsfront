                            ...
                            >
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        "hover:shadow-md hover:border-[rgb(var(--brand-primary))]/30",
                                        "focus:outline-none focus:ring-2 focus:ring-[rgb(var(--brand-primary))]/50"
                                    )}
                                >
                                    ...
                                    {organizations?.map((organization, index) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                <OrganizationCard
                                                    icon={
                                                        <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[rgb(var(--brand-primary))]/10 to-[rgb(var(--brand-primary))]/5 text-[rgb(var(--brand-primary))] shadow-inner border border-[rgb(var(--brand-primary))]/10">
    ...
    return (
        <button
            ...
            className={cn(
                ...
                "hover:shadow-xl hover:-translate-y-1 hover:border-[rgb(var(--brand-primary))]/30 dark:hover:border-[rgb(var(--brand-primary))]/20",
                selected && "ring-2 ring-[rgb(var(--brand-primary))] bg-[rgb(var(--brand-primary))]/5 border-[rgb(var(--brand-primary))]/50"
            )}
        >
