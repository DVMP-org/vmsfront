...
export function ResidentsSection() {
    ...
    const handleAddResident = async (data: ResidentCreate) => {
        ...
        // Assuming backend needs house_slugs or similar for creating resident relation
    ...
    return (
        <div className="space-y-4">
            ...
            >
                <div className="space-y-4">
                    <p>
                        Are you sure you want to remove <strong>{deletingResident?.resident.user.first_name} {deletingResident?.resident.user.last_name}</strong> from this house?
                    </p>
