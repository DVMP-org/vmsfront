            ...
            <div>
                <div className="flex items-center justify-between mb-2">
                    <label className={cn(
                        ...
                        errors.house_ids ? "text-destructive" : "text-foreground"
                    )}>
                    ...
                    {allHouses.length > 0 && (
                        ...
                        >
                            {selectedHouseIds.length === allHouses.length
                                ? "Deselect All"
                                : "Select All"}
                        </Button>
                    )}
                ...
                <div className={cn(
                    ...
                    errors.house_ids ? "border-destructive bg-destructive/5" : "border-border"
                )}>
                    {allHouses.length === 0 ? (
                ...
                {errors.house_ids && (
                    <p className="text-xs text-destructive mt-1">{errors.house_ids.message}</p>
                )}
            </div>
