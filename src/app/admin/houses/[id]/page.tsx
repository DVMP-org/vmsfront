                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2 mt-1.5">
                            <Badge variant={house?.is_active ? "success" : "secondary"} className="rounded-md">
                        ...
                        <CardContent className="p-6 space-y-4">
                            ...
                            {house?.description && (
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm leading-relaxed">{house?.description}</p>
                                </div>
                            )}
                    ...
                    <div className="p-6 border-b border-border/50 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground mt-0.5">Manage users living in this house</p>
                            </div>
                        </div>
                                ...
                                <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
                                    ...
                                    <div className="max-w-[280px]">
                                        ...
                                        <p className="text-sm text-muted-foreground mt-1">
                                            No users are currently assigned to this house.
                                        </p>
                                    </div>
