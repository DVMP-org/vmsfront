...
import { FolderOpen, Home as HomeIcon, MessageCircle, PlusCircle, Sparkles, Users, MessageSquare } from "lucide-react";
import { useAppStore } from "@/store/app-store";
import { useProfile } from "@/hooks/use-auth";
import { useCreateForumCategory, useCreateForumTopic, useForumCategoriesList, useForumTopics } from "@/hooks/use-forum";
...
HouseForumPage.getLayout = function getLayout(page: ReactElement) {
    return (
        <RouteGuard>
