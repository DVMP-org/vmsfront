...
export default function AdminForumTopicDetailPage() {
    ...
    const topicId = useMemo(() => (Array.isArray(params?.topicId) ? params.topicId[0] : params?.topicId) ?? "", [params]);
...
AdminForumTopicDetailPage.getLayout = function getLayout(page: ReactElement) {
    return (
        <RouteGuard>
