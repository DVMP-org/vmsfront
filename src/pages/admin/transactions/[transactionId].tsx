...
import { ArrowLeft, CreditCard, Clock, Calendar, ChevronRight, Code, Activity, Server, FileText, Copy, ShieldCheck, Search } from "lucide-react";
...
export default function TransactionDetailPage() {
    ...
    const id = useMemo(() => (Array.isArray(transactionId) ? transactionId[0] : transactionId) ?? "", [transactionId]);
...
TransactionDetailPage.getLayout = function getLayout(page: ReactElement) {
    return (
        <RouteGuard>
