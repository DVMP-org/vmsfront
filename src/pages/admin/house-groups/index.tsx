...
import { HouseGroupForm, HouseGroupFormData } from "@/components/modules/admin/house-groups/HouseGroupForm";
...
HouseGroupsPage.getLayout = function getLayout(page: ReactElement) {
    return (
        <RouteGuard>
