import { useMemo, useRef, useState, useEffect, ReactElement } from "react";
...
import { Users, Trash2, Download, Eye, Pencil, Upload, Plus } from "lucide-react";
...
ResidentsPage.getLayout = function getLayout(page: ReactElement) {
    return (
        <RouteGuard>
