        ...
        <>
            <div className="space-y-6">
                ...
                {isLoading ? (
                    ...
                    <>
                        <section className="rounded-3xl border border-border/60 bg-[rgb(var(--brand-primary)/0.9)] text-white shadow-xl">
...
AdminGatePassDetailPage.getLayout = function getLayout(page: ReactElement) {
    return (
        <RouteGuard>
