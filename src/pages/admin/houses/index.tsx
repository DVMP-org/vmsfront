import { useRef, useState, useMemo, useEffect, ReactElement } from "react";
...
import { Plus, Trash2, Edit, CheckCircle, Eye, Upload } from "lucide-react";
...
HousesPage.getLayout = function getLayout(page: ReactElement) {
    return (
        <RouteGuard>
