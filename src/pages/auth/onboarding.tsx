...
import { Loader2, ShieldCheck, Mail, User, Phone, MapPin, ChevronRight, ChevronLeft, CheckCircle2 } from "lucide-react";
...
export default function OnboardingPage() {
    ...
    const token = (queryToken as string) || null;
    ...
    useEffect(() => {
        ...
        verify();
    }, [token, router, setValue, clearAuth, router.isReady]);
